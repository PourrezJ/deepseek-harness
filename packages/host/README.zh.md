---
description: "Web GUI Host 侧的包映射：HTTP 与 SPA 服务器、工作区目录选择、桌面启动路由、插件清单与可选回环 Harness supervisor MCP。"
kind: "package-group"
---
...
| [`harness-supervisor-mcp/`](harness-supervisor-mcp/README.zh.md) | 面向现有 Harness 会话的可选回环 MCP 控制面 | `ctx.harnessSupervisorMcp` |
