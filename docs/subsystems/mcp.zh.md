...
<a id="ctxharnesssupervisormcp--harnesssupervisormcp"></a>

### `ctx.harnessSupervisorMcp` — `HarnessSupervisorMcp`

Harness-hosted loopback Streamable HTTP MCP server.

Source: [`packages/host/harness-supervisor-mcp/src/index.ts`](../../packages/host/harness-supervisor-mcp/src/index.ts)
